...
'''
######################################################################################################
#norm_FF = ROOT.RooRealVar("FFfit_norm",   "FF Normalization",FF.sumEntries(),0.0,10000.0)
...
######################################################################################################
#for ZZ
#norm_ZZ = ROOT.RooRealVar("ZZfit_norm",   "ZZ Normalization",ZZ.sumEntries(),0.0,10000.0)
